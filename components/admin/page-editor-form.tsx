...
export function PageEditorForm({
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
      ...
      {activeTab === "content" && <SchemaFieldRenderer fields={fields} register={form.register as never} watch={form.watch as never} parentKey="page_content" mediaOptions={mediaOptions} />}
